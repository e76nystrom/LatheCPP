...
enum CMD_MEGA
{
 MEGA_NONE,                     /*  0 x00 no command */
 MEGA_SET_RPM,                  /*  1 x01 set pwm for rpm */
 MEGA_GET_RPM,                  /*  2 x02 get pwm value */
 MEGA_POLL,                     /*  3 x03 poll mega info */
};

#ifdef ENUM_CMD_MEGA

const char *cmdMegaList[] = 
{
 "MEGA_NONE",                   /*  0 x00 no command */
 "MEGA_SET_RPM",                /*  1 x01 set pwm for rpm */
 "MEGA_GET_RPM",                /*  2 x02 get pwm value */
