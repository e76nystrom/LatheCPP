...
// setup operations
 ...
 CMD_ZSETUP,                    /* 0x18 setup z axis */
 CMD_ZSYNSETUP,                 /* 0x19 setup z axis sync */
 CMD_XSETUP,                    /* 0x1a setup x axis */
 CMD_XSYNSETUP,                 /* 0x1b setup z axis sync */
...
// load processor and xilinx parameters
 ...
 LOADMULTI,                     /* 0x1f load multiple parameters */
 READVAL,                       /* 0x20 read parameters */
 LOADXREG,                      /* 0x21 load xilinx registers */
 READXREG,                      /* 0x22 read xilinx registers */

// move command operations

 CLEARQUE,                      /* 0x23 clear move que */
 QUEMOVE,                       /* 0x24 que move command */
 MOVEQUESTATUS,                 /* 0x25 read move queue status */

// location and debug info

 READALL,                       /* 0x26 read all status info */
 READDBG,                       /* 0x27 read debug message */
 CLRDBG,                        /* 0x28 clear debug message buffer */

// encoder commands

 ENCSTART,                      /* 0x29 encoder start */
 ENCSTOP,                       /* 0x2a encoder stop */
};
