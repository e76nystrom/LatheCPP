...
inline uint16_t stpZRead() {return((Step1_GPIO_Port->IDR & Step1_Pin) != 0);}
#else
inline void stpZSet() {}
inline void stpZClr() {}
...
inline uint16_t stpXRead() {return((Step2_GPIO_Port->IDR & Step2_Pin) != 0);}
#else
inline void stpXSet() {}
inline void stpXClr() {}
...
inline uint16_t step3Read() {return((Step3_GPIO_Port->IDR & Step3_Pin) != 0);}
#else
...
inline uint16_t step4Read() {return((Step4_GPIO_Port->IDR & Step4_Pin) != 0);}
#else
...
inline uint16_t step5Read() {return((Step5_GPIO_Port->IDR & Step5_Pin) != 0);}
#else
...
inline uint16_t dirZRead() {return((Dir1_GPIO_Port->IDR & Dir1_Pin) != 0);}
#else
inline void dirZSet() {}
inline void dirZClr() {}
...
inline uint16_t dirXRead() {return((Dir2_GPIO_Port->IDR & Dir2_Pin) != 0);}
#else
inline void dirXSet() {}
inline void dirXClr() {}
...
inline uint16_t dir3Read() {return((Dir3_GPIO_Port->IDR & Dir3_Pin) != 0);}
#else
inline void dir3Set() {}
inline void dir3Clr() {}
...
inline uint16_t dir4Read() {return((Dir4_GPIO_Port->IDR & Dir4_Pin) != 0);}
#else
inline void dir4Set() {}
inline void dir4Clr() {}
...
inline uint16_t dir5Read() {return((Dir5_GPIO_Port->IDR & Dir5_Pin) != 0);}
#else
inline void dir5Set() {}
inline void dir5Clr() {}
...
inline uint16_t pin1Read() {return((Pin1_GPIO_Port->IDR & Pin1_Pin) != 0);}
#else
inline void pin1Set() {}
inline void pin1Clr() {}
...
inline uint16_t spRunRead() {return((Pin1_GPIO_Port->IDR & Pin1_Pin) != 0);}
#else
...
inline uint16_t pin14Read() {return((Pin14_GPIO_Port->IDR & Pin14_Pin) != 0);}
#else
...
inline uint16_t pin16Read() {return((Pin16_GPIO_Port->IDR & Pin16_Pin) != 0);}
#else
...
inline uint16_t pin17Read() {return((Pin17_GPIO_Port->IDR & Pin17_Pin) != 0);}
#else
...
inline uint16_t startRead() {return((Start_GPIO_Port->IDR & Start_Pin) != 0);}
#else
...
inline uint16_t aRead() {return((Pin1_GPIO_Port->IDR & Pin1_Pin) != 0);}
#else
inline void aSet() {}
inline void aClr() {}
...
inline uint16_t bRead() {return((Pin14_GPIO_Port->IDR & Pin14_Pin) != 0);}
#else
inline void bSet() {}
inline void bClr() {}
...
inline uint16_t syncRead() {return((Pin17_GPIO_Port->IDR & Pin17_Pin) != 0);}
#else
inline void syncSet() {}
inline void syncClr() {}
