...
#define RUN_OUT_INIT         (1 << 0)   /* 0x001 runout init */
#define RUN_OUT_ENA          (1 << 1)   /* 0x002 runout enable */
#define RUN_OUT_DIR          (1 << 2)   /* 0x004 runout direction */
#define RUN_OUT_CTL_SIZE     3
...
#define Z_FREQ_SHIFT         (0 << 0)   /* 0x000 z clock shift */
#define X_FREQ_SHIFT         (3 << 0)   /* 0x003 x clock shift */
#define CLK_MASK             (7 << 0)   /* 0x007 clock mask */

// clock selection values

#define CLK_NONE             (0 << 0)   /* 0x000  */
#define CLK_FREQ             (1 << 0)   /* 0x001  */
#define CLK_CH               (2 << 0)   /* 0x002  */
#define CLK_INT_CLK          (3 << 0)   /* 0x003  */
#define CLK_SLV_FREQ         (4 << 0)   /* 0x004  */
#define CLK_SLV_CH           (5 << 0)   /* 0x005  */
#define CLK_SPINDLE          (6 << 0)   /* 0x006  */
#define CLK_DBG_FREQ         (7 << 0)   /* 0x007  */

// z clock values

#define Z_CLK_NONE           (0 << 0)   /* 0x000  */
#define Z_CLK_ZFREQ          (1 << 0)   /* 0x001  */
#define Z_CLK_CH             (2 << 0)   /* 0x002  */
#define Z_CLK_INT_CLK        (3 << 0)   /* 0x003  */
#define Z_CLK_XFREQ          (4 << 0)   /* 0x004  */
#define Z_CLK_XCH            (5 << 0)   /* 0x005  */
#define Z_CLK_SPINDLE        (6 << 0)   /* 0x006  */
#define Z_CLK_DBG_FREQ       (7 << 0)   /* 0x007  */

// x clock values

#define X_CLK_NONE           (0 << 3)   /* 0x000  */
#define X_CLK_XFREQ          (1 << 3)   /* 0x008  */
#define X_CLK_CH             (2 << 3)   /* 0x010  */
#define X_CLK_INT_CLK        (3 << 3)   /* 0x018  */
#define X_CLK_ZFREQ          (4 << 3)   /* 0x020  */
#define X_CLK_ZCH            (5 << 3)   /* 0x028  */
#define X_CLK_SPINDLE        (6 << 3)   /* 0x030  */
#define X_CLK_DBG_FREQ       (7 << 3)   /* 0x038  */
...
#define SYN_ENC_CLK_SEL      (0x3 << 3) /* 0x018 encoder clk sel */
#define SYN_CTL_SIZE         5

// encoder clock shift

#define ENC_CLK_SHIFT        (3 << 0)   /* 0x003 enc clock shift */

// encoder clock values

#define ENC_CLK_NONE         (0 << 0)   /* 0x000  */
#define ENC_CLK_CH           (1 << 0)   /* 0x001  */
#define ENC_CLK_SP           (2 << 0)   /* 0x002  */
#define ENC_CLK_DBG          (3 << 0)   /* 0x003  */

// encoder clock values shifted

#define SYN_ENC_CLK_NONE     (0 << 3)   /* 0x000  */
#define SYN_ENC_CLK_CH       (1 << 3)   /* 0x008  */
#define SYN_ENC_CLK_SP       (2 << 3)   /* 0x010  */
#define SYN_ENC_CLK_DBG      (3 << 3)   /* 0x018  */
